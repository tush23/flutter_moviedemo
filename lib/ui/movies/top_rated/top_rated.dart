...
import 'package:flutter_moviedemo/bloc/movie_toprated_bloc.dart';
...
import 'package:flutter_moviedemo/ui/movies/details/movie_details.dart';
...
class _TopRatedListState extends State<TopRatedList> {
  ...
  void initState() {
    super.initState();
    movieTopRatedBloc..getTopRatedMovies();
  }

  @override
  Widget build(BuildContext context) {
    return StreamBuilder<MovieResponse>(
      stream: movieTopRatedBloc.subject.stream,
          ...
          return Column(
            children: <Widget>[
              Container(
                ...
                margin: EdgeInsets.only(left: 15, bottom: 6, top: 15),
                child: Text(
                  "Top Rated Movies",
                  style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
                ),
              ),
              _buildMoviesTopRatedWidget(snapshot.data),
            ],
          );
  ...
  Widget _buildMoviesTopRatedWidget(MovieResponse data) {
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  MovieDetail(movies: movies[index])));
                    },
                    child: Column(
