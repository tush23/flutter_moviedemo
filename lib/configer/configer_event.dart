...
class DarkModeEvent extends ConfigerEvent{
  ...
  @override
  Stream<ConfigerState> applyAsync({ConfigerState currentState, ConfigerBloc bloc})async* {
    ...
    try{
      ...
      developer.log('$_', name: 'DarkModeEvent', error: _, stackTrace: stackTrace);
...
class LoadConfigerEvent extends ConfigerEvent {
  ...
  Stream<ConfigerState> applyAsync(
    ...
    try {
      ...
      developer.log('$_', name: 'LoadConfigerEvent', error: _, stackTrace: stackTrace);
      yield ErrorConfigerState( _?.toString());
    }
  }
}
